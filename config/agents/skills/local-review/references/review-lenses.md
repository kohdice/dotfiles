...
| performance  | `performance-reviewer`                                                                  | Runtime cost in hot paths: algorithmic complexity, allocations/copies, redundant work, unbuffered I/O                                                                                                                                                                                                          | High = O(n²) growth, or a per-item cost (allocation, copy, syscall) in a hot loop |
