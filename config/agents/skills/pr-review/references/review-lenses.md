...
| performance  | Unnecessary heap allocations, hidden copies, reallocation churn in hot paths | A per-item allocation/copy introduced into a hot loop, or O(n²) growth                      | `performance-reviewer`                                                                                            |
