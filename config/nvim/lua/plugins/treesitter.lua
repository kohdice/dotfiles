return {
  {
    ...
    config = function()
      ...
      -- The buftype/parser/large-file guard lives in utils.treesitter so that
      -- after/indent/<ft>.lua makes the same decision and no buffer ends up
      -- with only one half enabled
